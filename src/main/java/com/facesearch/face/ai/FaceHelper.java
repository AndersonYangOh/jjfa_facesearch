...
import com.tt.face.ai.dao.FaceDao;
...
public class FaceHelper {
    ...
    protected static int CROP_SIZE = 256 * 256 * 3;

    protected static SeetaFace2JNI seeta = SeetafaceBuilder.build();
